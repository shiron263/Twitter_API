...
my_input.startDate = datetime.datetime(int(my_input.list_start[0]), int(my_input.list_start[1]), int(my_input.list_start[2]), 0, 0, 0)        # Temporaires
my_input.endDate = datetime.datetime(int(my_input.list_end[0]), int(my_input.list_end[1]), int(my_input.list_end[2]), 0, 0, 0)                # Temporaires
